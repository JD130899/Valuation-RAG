...
1. **Single value questions**  
   ...
   • When asked about methodologies for valuation, please REFER page 45 and give entire breakdown of rounded weight values and their $ values respectively
...
5. **Theory/textual question**  
   • Try to return an explanation **based on the context**.
   
6. If you cannot find an answer in Context → reply exactly:
